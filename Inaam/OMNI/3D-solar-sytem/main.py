...
def update():
    ...
    # revolves around the sun
     ...
     # there are a total of 9 planets revolving around the sun so 360/9 = 40, each planet is 40 degrees apart, angle is in radians
     # variable t is a time variable, that is, when taking the cosine and sine of t, each frame the planets will change position according to the coordinates calculated by t
     #9 I'm giving random distances to this planet because I'm too lazy to calculate it
